                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="content">
                                <form class="form-group" method="post" action="<?= base_url('editphoto/update'); ?>" enctype="multipart/form-data">
                                    <input type="hidden" id="photoid" name="photoid" value="<?= $photo['photoid']; ?>">
                                    <input type="hidden" id="photoaddress" name="photoaddress" value="<?= $photo['photoaddress']; ?>">
                                    <input type="hidden" id="status" name="status" value="<?= $photo['status']; ?>">
                                    <div class="row">
                                        <div class="col-md-9">
                                            <div class="form-group">
                                                <label>Título da foto</label>
                                                <input type="text" id="phototitle" name="phototitle" value="<?= $photo['phototitle']; ?>" class="form-control border-input" placeholder="Título da foto" required="true">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Data da foto</label>
                                                <input type="date" id="photodate" name="photodate" value="<?= $photo['photodate']; ?>" class="form-control border-input" placeholder="Título da foto" required="true">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
